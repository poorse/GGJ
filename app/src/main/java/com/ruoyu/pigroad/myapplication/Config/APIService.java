 ...
 */
package com.ruoyu.pigroad.myapplication.Config;

import java.io.File;

import com.ruoyu.pigroad.myapplication.Util.AccessToken;
import com.ruoyu.pigroad.myapplication.Util.HttpUtil;
import com.ruoyu.pigroad.myapplication.Widget.RegParams;
import com.ruoyu.pigroad.myapplication.Widget.DeviceUuidFactory;
import com.ruoyu.pigroad.myapplication.Util.OnResultListener;
import com.ruoyu.pigroad.myapplication.Widget.RegResultParser;
...
public class APIService {
    ...
    //人脸更新接口
    private static final String UPREG_URL = BASE_URL + "/rest/2.0/face/v3/faceset/user/update";
     ...
     * 更新人脸库
     */
    public void upreg(OnResultListener listener, File file, String uid, String username) {
        RegParams params = new RegParams();
        String base64Img = "";
        try {
            byte[] buf = readFile(file);
        ...
        RegResultParser parser = new RegResultParser();
        String url = urlAppendCommonParams(UPREG_URL);
        HttpUtil.getInstance().post(url, params, parser, listener);
    }
