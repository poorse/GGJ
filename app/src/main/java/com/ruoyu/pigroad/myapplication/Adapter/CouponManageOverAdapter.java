 ...
 */
public class CouponManageOverAdapter extends RecyclerView.Adapter<CouponManageOverAdapter.ViewHolder>{

    private Context context;
    private List<CouponManageBean3> datas;

    public CouponManageOverAdapter(Context context, List<CouponManageBean3> datas){
    ...
    @NonNull
    @Override
    public CouponManageOverAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.coupon_used_item,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CouponManageOverAdapter.ViewHolder holder, final int position) {
