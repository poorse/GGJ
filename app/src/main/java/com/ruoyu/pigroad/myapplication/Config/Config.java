...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
  //  public static String apiKey =  "gbm2eLLIYzveqes2hHpvivDv";
 //   public static String secretKey = "buWhqv9pSKb7GDCgG0xBAdx3ROCOAStG";
    public static String licenseID = "youkelai-face-android";
     ...
     */
 //   public static String groupID = "facedemo";
