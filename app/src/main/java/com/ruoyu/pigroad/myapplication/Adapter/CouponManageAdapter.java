 ...
 */
public class CouponManageAdapter extends RecyclerView.Adapter<CouponManageAdapter.ViewHolder>{

    private Context context;
    private List<CouponManageBean> datas;

    public CouponManageAdapter(Context context, List<CouponManageBean> datas){
    ...
    @NonNull
    @Override
    public CouponManageAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.coupon_manager_item,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CouponManageAdapter.ViewHolder holder, final int position) {
